...
import net.mcreator.changedforge.world.features.ores.FurrOreFeature;
...
public class ChangedforgeModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(FurrOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, FurrOreFeature.GENERATE_BIOMES,
				FurrOreFeature.CONFIGURED_FEATURE));
	}
